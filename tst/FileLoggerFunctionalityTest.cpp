...
namespace com { namespace amazonaws { namespace kinesis { namespace video {
    ...
    TEST_F(FileLoggerFunctionalityTest, basicFileLoggerUsage)
    {
        ...
        FREMOVE(TEST_TEMP_DIR_PATH "kvsProducerLogIndex");
        FREMOVE(TEST_TEMP_DIR_PATH "kvsProducerLog.0");
        FREMOVE(TEST_TEMP_DIR_PATH "kvsProducerLog.1");
        FREMOVE(TEST_TEMP_DIR_PATH "kvsProducerLog.2");
        ...
        EXPECT_EQ(STATUS_SUCCESS, fileExists((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLog.0"), &fileFound));
        ...
        EXPECT_EQ(STATUS_SUCCESS, fileExists((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLog.0"), &fileFound));
        EXPECT_EQ(FALSE, fileFound);
        EXPECT_EQ(STATUS_SUCCESS, fileExists((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLogIndex"), &fileFound));
        ...
        EXPECT_EQ(STATUS_SUCCESS, fileExists((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLog.1"), &fileFound));
        EXPECT_EQ(TRUE, fileFound);

        EXPECT_EQ(STATUS_SUCCESS, fileExists((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLogIndex"), &fileFound));
        EXPECT_EQ(TRUE, fileFound); // index file should be there

        EXPECT_EQ(STATUS_SUCCESS, readFile((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLogIndex"), TRUE, NULL, &fileIndexBufferSize));
        EXPECT_EQ(STATUS_SUCCESS, readFile((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLogIndex"), TRUE, (PBYTE) fileIndexBuffer, &fileIndexBufferSize));
        ...
        EXPECT_EQ(STATUS_SUCCESS, fileExists((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLog.2"), &fileFound));
    ...
    TEST_F(FileLoggerFunctionalityTest, checkFileRotation)
    {
        ...
        for(; i < logIterationCount; ++i) {
            SPRINTF(filePath, TEST_TEMP_DIR_PATH "kvsProducerLog.%u", i);
            FREMOVE(filePath);
        }
    ...
    TEST_F(FileLoggerFunctionalityTest, fileLoggerPicksUpFromLastFileIndex)
    {
        ...
        EXPECT_EQ(STATUS_SUCCESS, writeFile((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLogIndex"), TRUE, FALSE, (PBYTE) fileIndexBuffer, STRLEN(fileIndexBuffer) * SIZEOF(CHAR)));
        ...
        EXPECT_EQ(STATUS_SUCCESS, fileExists((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLog.128"), &fileFound));
        EXPECT_EQ(TRUE, fileFound);
        EXPECT_EQ(STATUS_SUCCESS, fileExists((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLogIndex"), &fileFound));
        EXPECT_EQ(TRUE, fileFound); // index file should be there
        ...
        EXPECT_EQ(STATUS_SUCCESS, fileExists((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLog.129"), &fileFound));
        EXPECT_EQ(TRUE, fileFound);
    ...
    TEST_F(FileLoggerFunctionalityTest, logMessageLongerThanStringBuffer)
    {
        ...
        EXPECT_EQ(STATUS_SUCCESS, readFile((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLog.0"), TRUE, NULL, &fileBufferLen));
        EXPECT_EQ(STATUS_SUCCESS, readFile((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLog.0"), TRUE, (PBYTE) fileBuffer, &fileBufferLen));
    ...
    TEST_F(FileLoggerFunctionalityTest, oldLogFileOverrittenByFlushTriggerredByNewLog)
    {
        ...
        FREMOVE(TEST_TEMP_DIR_PATH "kvsProducerLog.1");
        FREMOVE(TEST_TEMP_DIR_PATH "kvsProducerLog.2");
        FREMOVE(TEST_TEMP_DIR_PATH "kvsProducerLog.3");
        ...
        EXPECT_EQ(STATUS_SUCCESS, fileExists((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLog.0"), &fileFound));
        EXPECT_EQ(FALSE, fileFound);
        EXPECT_EQ(STATUS_SUCCESS, fileExists((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLog.3"), &fileFound));
        EXPECT_EQ(TRUE, fileFound);

        EXPECT_EQ(STATUS_SUCCESS, readFile((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLog.3"), TRUE, NULL, &fileBufferLen));
    ...
    TEST_F(FileLoggerFunctionalityTest, oldLogFileOverrittenByFlushTriggerredByFreeCallbacks)
    {
        ...
        EXPECT_EQ(STATUS_SUCCESS, readFile((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLog.1"), TRUE, NULL, &fileBufferLen));
        EXPECT_EQ(STATUS_SUCCESS, readFile((PCHAR) (TEST_TEMP_DIR_PATH "kvsProducerLog.1"), TRUE, (PBYTE) fileBuffer, &fileBufferLen));
        fileBuffer[fileBufferLen] = '\0';
