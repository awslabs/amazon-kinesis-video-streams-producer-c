...
iotRoleName="producerc_role"
iotRoleAlias="producerc_role_alias"
iotCert="producerc_certificate.pem"
iotPublicKey="producerc_public.key"
iotPrivateKey="producerc_private.key"
