...
INT32 main(INT32 argc, CHAR *argv[])
{
    ...
    CHK_STATUS(mkvgenGeneratePcmCpd(KVS_PCM_FORMAT_CODE_MULAW, AUDIO_TRACK_SAMPLING_RATE, AUDIO_TRACK_CHANNEL_CONFIG, pAudioTrack->codecPrivateData, pAudioTrack->codecPrivateDataSize));
