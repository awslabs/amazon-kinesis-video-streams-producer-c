 ...
 * Create IoT credentials callback
 */
STATUS createIotAuthCallbacksWithTimeoutsAndIPVersion(PClientCallbacks pCallbacksProvider, PCHAR iotGetCredentialEndpoint, PCHAR certPath, PCHAR privateKeyPath,
                                          ...
                                          PAuthCallbacks* ppIotAuthCallbacks)
{
    ...
    CHK_STATUS(createCurlIotCredentialProviderWithTimeAndTimeoutAndIPVersion(
        iotGetCredentialEndpoint, certPath, privateKeyPath, caCertPath, roleAlias, streamName, connectionTimeout, completionTimeout, ipVersion,
        pIotAuthCallbacks->pCallbacksProvider->clientCallbacks.getCurrentTimeFn, pIotAuthCallbacks->pCallbacksProvider->clientCallbacks.customData,
        (PAwsCredentialProvider*) &pIotAuthCallbacks->pCredentialProvider));
