                                                                   ...
                                                                   PClientCallbacks* ppClientCallbacks)
{
    ...
    CHK_STATUS(createIotAuthCallbacksWithTimeoutsAndIPVersion((PClientCallbacks) pCallbacksProvider, endpoint, iotCertPath, privateKeyPath, caCertPath, roleAlias,
