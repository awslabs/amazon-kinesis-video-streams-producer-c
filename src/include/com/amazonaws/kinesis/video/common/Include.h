...
#define STATUS_STREAM_BEING_SHUTDOWN                        STATUS_COMMON_PRODUCER_BASE + 0x00000026
#define STATUS_CLIENT_BEING_SHUTDOWN                        STATUS_COMMON_PRODUCER_BASE + 0x00000027
#define STATUS_CONTINUOUS_RETRY_RESET_FAILED                STATUS_COMMON_PRODUCER_BASE + 0x00000028
/*!@} */
